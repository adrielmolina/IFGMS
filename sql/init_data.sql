...
VALUES
    (NULL, 1, 'Gold', 'PG1000001', 1, TRUE, TRUE, '2025-04-20', TRUE, 10223, '2025-04-01', NULL, NULL, NULL, NULL),
    (NULL, 1, 'Silver', 'PS1000002', 2, TRUE, FALSE, '2025-04-21', FALSE, 10224, '2025-04-02', NULL, NULL, NULL, NULL),
    (NULL, 1, 'Bronze', 'PB1000003', 3, FALSE, TRUE, '2025-04-22', TRUE, 10225, '2025-04-03', NULL, NULL, NULL, NULL),
    (NULL, 1, 'Classic', '1000004', 4, TRUE, TRUE, '2025-04-23', FALSE, 10226, '2025-04-04', NULL, NULL, NULL, NULL),
    (NULL, 1, 'Platinum', 'PP1000005', 5, FALSE, TRUE, '2025-04-24', TRUE, 10227, '2025-04-05', NULL, NULL, NULL, NULL),

    (NULL, 2, 'Enhanced Platinum', 'EP2000006', 6, TRUE, TRUE, '2025-05-10', TRUE, 20223, '2025-05-01', NULL, NULL, NULL, NULL),
    (NULL, 2, 'Senior', 'S02000007', 7, FALSE, TRUE, '2025-05-11', FALSE, 20224, '2025-05-02', NULL, NULL, NULL, NULL),
    (NULL, 2, 'Senior+', 'SP2000008', 8, TRUE, FALSE, '2025-05-12', TRUE, 20225, '2025-05-03', NULL, NULL, NULL, NULL),
    (NULL, 2, 'Gold', 'PG2000009', 9, TRUE, TRUE, '2025-05-13', FALSE, 20226, '2025-05-04', NULL, NULL, NULL, NULL),
    (NULL, 2, 'Silver', 'PS2000010', 10, FALSE, TRUE, '2025-05-14', TRUE, 20227, '2025-05-05', NULL, NULL, NULL, NULL),

    (NULL, 3, 'Bronze', 'PB3000011', 11, TRUE, TRUE, '2025-06-10', TRUE, 30223, '2025-06-01', NULL, NULL, NULL, NULL),
    (NULL, 3, 'Classic', '3000012', 12, TRUE, FALSE, '2025-06-11', FALSE, 30224, '2025-06-02', NULL, NULL, NULL, NULL),
    (NULL, 3, 'Platinum', 'PP3000013', 13, FALSE, TRUE, '2025-06-12', TRUE, 30225, '2025-06-03', NULL, NULL, NULL, NULL),
    (NULL, 3, 'Enhanced Platinum', 'EP3000014', 14, TRUE, TRUE, '2025-06-13', FALSE, 30226, '2025-06-04', NULL, NULL, NULL, NULL),
    (NULL, 3, 'Senior', 'S03000015', 15, FALSE, TRUE, '2025-06-14', TRUE, 30227, '2025-06-05', NULL, NULL, NULL, NULL),

    (NULL, 4, 'Senior+', 'SP4000016', 16, TRUE, TRUE, '2025-07-10', TRUE, 40223, '2025-07-01', NULL, NULL, NULL, NULL),
    (NULL, 4, 'Gold', 'PG4000017', 17, FALSE, TRUE, '2025-07-11', FALSE, 40224, '2025-07-02', NULL, NULL, NULL, NULL),
    (NULL, 4, 'Silver', 'PS4000018', 18, TRUE, FALSE, '2025-07-12', TRUE, 40225, '2025-07-03', NULL, NULL, NULL, NULL),
    (NULL, 4, 'Bronze', 'PB4000019', 19, TRUE, TRUE, '2025-07-13', FALSE, 40226, '2025-07-04', NULL, NULL, NULL, NULL),
    (NULL, 4, 'Classic', '4000020', 20, FALSE, TRUE, '2025-07-14', TRUE, 40227, '2025-07-05', NULL, NULL, NULL, NULL),

    (NULL, 5, 'Platinum', 'PP5000021', 21, TRUE, TRUE, '2025-08-10', TRUE, 50223, '2025-08-01', NULL, NULL, NULL, NULL),
    (NULL, 5, 'Enhanced Platinum', 'EP5000022', 22, TRUE, FALSE, '2025-08-11', FALSE, 50224, '2025-08-02', NULL, NULL, NULL, NULL),
    (NULL, 5, 'Senior', 'S05000023', 23, FALSE, TRUE, '2025-08-12', TRUE, 50225, '2025-08-03', NULL, NULL, NULL, NULL),
    (NULL, 5, 'Senior+', 'SP5000024', 24, TRUE, TRUE, '2025-08-13', FALSE, 50226, '2025-08-04', NULL, NULL, NULL, NULL),
    (NULL, 5, 'Gold', 'PG5000025', 25, FALSE, TRUE, '2025-08-14', TRUE, 50227, '2025-08-05', NULL, NULL, NULL, NULL)
;
